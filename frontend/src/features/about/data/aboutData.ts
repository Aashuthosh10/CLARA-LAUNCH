...
export const CREATORS_FIVE: CreatorMember[] = [
  {
    ...
    specialization: ['Contact: aashuthoshn@gmail.com', 'USN: 1VA23CD001'],
    bio: 'Researched and built the semantic understanding engine, designing intent classification pipelines, LLM integrations, and contextual disambiguation models for natural student-institution conversations.',
  ...
  },
  {
    id: 'c2',
    name: 'Adithya N C',
    role: 'System & UI/UX Engineer',
    specialization: ['Contact: ncadithya2004@gmail.com', 'USN: 1VA23CD002'],
    bio: "Designed CLARA’s sleek, intuitive visual interface and engineered robust system interactions. Bridged the gap between complex backend data and a seamless, accessible user experience tailored for front-desk environments.",
    avatarSeed: 'adithya',
    image: adithyaImage,
  },
  {
    id: 'c4',
    name: 'Dhanush Sridhar Babu',
    role: 'Spatial Design & Data Architect',
    specialization: ['Contact: dhanushs.babu0245@gmail.com', 'USN: 1VA23CD026'],
    bio: "Spearheaded foundational research and comprehensive database aggregation to build CLARA's knowledge core. Designed the external physical kiosk, led systems integration, and engineered the interactive navigation system to seamlessly bridge complex data with a user-centric front-desk experience.",
    avatarSeed: 'dhanush',
    image: dhanushImage,
  },
  {
    id: 'c5',
    name: 'M. Naveen Kumar',
    role: 'System Design and Frontend Architect',
    specialization: ['Contact: m.naveenkumar6360@gmail.com', 'USN: 1VA23CD046'],
    bio: "Architected the core structural design of CLARA's interface and developed the responsive, interactive frontend components. Ensured highly optimized rendering and a flawless graphical user interface across the kiosk hardware.",
    avatarSeed: 'naveen',
    image: naveenImage,
  },
];

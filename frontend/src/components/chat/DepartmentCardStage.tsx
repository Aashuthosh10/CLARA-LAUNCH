...
export default function DepartmentCardStage({
  ...
  return (
    <div className="relative w-full h-full flex flex-col p-8 rounded-3xl shadow-2xl overflow-hidden isolation-auto justify-center">
      ...
      {/* Progressive Sync Bar */}
      <div className="absolute bottom-0 left-0 right-0 h-1.5 bg-white/10 overflow-hidden">
         <motion.div
           key={`${chipText ?? departmentLabel}-${safeIdx}-progress`}
           className="h-full bg-gradient-to-r from-violet-500 to-fuchsia-500 shadow-[0_0_12px_rgba(168,85,247,0.8)]"
           initial={{ width: "0%" }}
           animate={{ width: "100%" }}

...
export default function PremiumHODCardDataScience() {
  ...
  const data = {
    ...
    bio: {
      ...
      Hindi: "डॉ. नागश्री एन के पास 12 वर्षों से अधिक का शिक्षण और शोध अनुभव है। उन्होंने बायोमेडिकल इमेज प्रोसेसिंग और डीप लर्निंग में पीएचडी पूरी की है।"
    },
  ...
  const selectedBio = language === 'Kannada'
    ? String(collegeDataForLanguage('Kannada').departments?.cse_ds?.hod_voice ?? '')

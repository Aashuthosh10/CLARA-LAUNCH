    ...
    <div className={`light-chat-container ${scriptPreset.cssClass}`} data-testid="chat-screen" lang={languageToCode(language)}>
      ...
      <AnimatePresence mode="wait">
          ...
          {layoutMode === 'FULL_TEXT' ? (
            ...
            >
              <div
                  className={`full-text-message-stage relative z-10 flex min-h-0 flex-col${departmentComparisonOpen ? ' full-text-message-stage--with-comparison' : ''}${visualAnswerPresentation ? ' full-text-message-stage--adaptive-answer' : ''}`}
              >
                <div

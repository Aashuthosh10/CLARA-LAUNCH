...
_LEADERSHIP_DESCRIPTORS: tuple[ContentUnitDescriptor, ...] = (
    ...
    ContentUnitDescriptor(
        unit_id=UNIT_DEAN_ACADEMICS,
        surface="dean_academics",
        content_type=ContentType.VICE_PRINCIPAL.value,
        entity_type=LEADERSHIP_ENTITY,
        entity_id=LEADERSHIP_ENTITY,
        context=LEADERSHIP_ENTITY,
        context_id=TOPIC_DEAN_ACADEMICS,
        section_id=TOPIC_DEAN_ACADEMICS,
        unit_suffix=TOPIC_DEAN_ACADEMICS,
        canonical_source="backend/services/content/dean_profiles.py",
        adapter_key="dean",
        presentation_role=TOPIC_DEAN_ACADEMICS,
    ),
    ContentUnitDescriptor(
        unit_id=UNIT_DEAN_ADMINISTRATION,
        surface="dean_administration",
        content_type=ContentType.VICE_PRINCIPAL.value,
        entity_type=LEADERSHIP_ENTITY,
        entity_id=LEADERSHIP_ENTITY,
        context=LEADERSHIP_ENTITY,
        context_id=TOPIC_DEAN_ADMINISTRATION,
        section_id=TOPIC_DEAN_ADMINISTRATION,
        unit_suffix=TOPIC_DEAN_ADMINISTRATION,
        canonical_source="backend/services/content/dean_profiles.py",
        adapter_key="dean",
        presentation_role=TOPIC_DEAN_ADMINISTRATION,
    ),
    ContentUnitDescriptor(
        unit_id=UNIT_DEAN_STUDENT_AFFAIRS,
        surface="dean_student_affairs",
        content_type=ContentType.VICE_PRINCIPAL.value,
        entity_type=LEADERSHIP_ENTITY,
        entity_id=LEADERSHIP_ENTITY,
        context=LEADERSHIP_ENTITY,
        context_id=TOPIC_DEAN_STUDENT_AFFAIRS,
        section_id=TOPIC_DEAN_STUDENT_AFFAIRS,
        unit_suffix=TOPIC_DEAN_STUDENT_AFFAIRS,
        canonical_source="backend/services/content/dean_profiles.py",
        adapter_key="dean",
        presentation_role=TOPIC_DEAN_STUDENT_AFFAIRS,
    ),
    ContentUnitDescriptor(
        unit_id=UNIT_ASSOCIATE_DEAN_RND,
        surface="associate_dean_rnd",
        content_type=ContentType.VICE_PRINCIPAL.value,
        entity_type=LEADERSHIP_ENTITY,
        entity_id=LEADERSHIP_ENTITY,
        context=LEADERSHIP_ENTITY,
        context_id=TOPIC_ASSOCIATE_DEAN_RND,
        section_id=TOPIC_ASSOCIATE_DEAN_RND,
        unit_suffix=TOPIC_ASSOCIATE_DEAN_RND,
        canonical_source="backend/services/content/dean_profiles.py",
        adapter_key="dean",
        presentation_role=TOPIC_ASSOCIATE_DEAN_RND,
    ),
    ContentUnitDescriptor(
        unit_id=UNIT_DEAN_INNOVATION,
        surface="dean_innovation",
        content_type=ContentType.VICE_PRINCIPAL.value,
        entity_type=LEADERSHIP_ENTITY,
        entity_id=LEADERSHIP_ENTITY,
        context=LEADERSHIP_ENTITY,
        context_id=TOPIC_DEAN_INNOVATION,
        section_id=TOPIC_DEAN_INNOVATION,
        unit_suffix=TOPIC_DEAN_INNOVATION,
        canonical_source="backend/services/content/dean_profiles.py",
        adapter_key="dean",
        presentation_role=TOPIC_DEAN_INNOVATION,
    ),
    ContentUnitDescriptor(

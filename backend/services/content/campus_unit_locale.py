...
_TTS_LEAD: dict[str, str] = {
    "en": "This sample card covers {label}. {focus}. Official facts are not confirmed yet.",
    "kn": "ಈ ಮಾದರಿ ಕಾರ್ಡ್ {label} ಬಗ್ಗೆ. {focus}. ಅಧಿಕೃತ ಅಂಶಗಳು ಇನ್ನೂ ದೃಢಪಟ್ಟಿಲ್ಲ.",
    "hi": "यह नमूना कार्ड {label} के बारे में है। {focus}। आधिकारिक तथ्य अभी पुष्ट नहीं हैं।",
    "ta": "இந்த மாதிரி அட்டை {label} பற்றியது. {focus}. அதிகாரப்பூர்வ தகவல் இன்னும் உறுதிப்படவில்லை.",
    "te": "ఈ నమూనా కార్డ్ {label} గురించి. {focus}. అధికారిక విషయాలు ఇంకా నిర్ధారణ కాలేదు.",
    "ml": "ഈ സാമ്പിൾ കാർഡ് {label} സംബന്ധിച്ചതാണ്. {focus}. ഔദ്യോഗിക വിവരങ്ങൾ ഇതുവരെ സ്ഥിരീകരിച്ചിട്ടില്ല.",
}
